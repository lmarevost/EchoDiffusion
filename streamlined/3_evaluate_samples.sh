...
FAKE_DATA="/mimer/NOBACKUP/priv/chair/echo_anouka_luismi/streamlined/synthetic_samples/train_$CURRENT_PARAM/PNG"
...
# Subsample sizes
N_RUNS=5  # number of independent runs (subsets) to evaluate

# Logging path
LOG_PATH="/mimer/NOBACKUP/priv/chair/echo_anouka_luismi/streamlined/FID_logs/train_$CURRENT_PARAM"
